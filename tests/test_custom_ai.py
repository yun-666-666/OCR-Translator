...
class CostProtectedProfileFailoverHandlerTests(unittest.TestCase):
    ...
    def test_custom_ai_translation_stops_failover_after_app_is_stopped(self):
        handler, primary, _fallback = self._make_handler()
        try:
            attempted_profiles = []
            ...
            def translate(profile, *_args, **_kwargs):
                ...
                if profile["id"] == primary["id"]:
                    ...
                    raise ValueError("primary failed after app stopped")
                return "unwanted fallback translation", {}, 0.01
