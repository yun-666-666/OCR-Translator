        ...
        if cached_result:
            ...
            if file_cache_enabled and cache_key_for_file:
                ...
                if not file_cache_result:
                    _log_debug(f"LRU cache hit but file cache miss. Saving to {provider_name} file cache.")
                    self.app.cache_manager.save_to_file_cache(provider_name, cache_key_for_file, cached_result)
                else:
                    _log_debug(f"Translation found in both LRU cache and {provider_name} file cache.")
